...
class AtomInstallerTest {
    ...
    @InjectMocks
    private lateinit var atomInstaller: AtomInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.atom")

        ReflectionTestUtils.setField(atomInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${atomInstaller.DEFAULT_URL}"
