...
class ScreenInstallerTest {
    ...
    fun `test successful installation with default command`() {
        ...
        verify(strategy).invoke(    "mkdir -p /tmp/installer-screen && " +
                "cd /tmp/installer-screen && " +
                "curl -fsSL ${screenInstaller.DEFAULT_URL} -o screen-4.9.1.tar.gz && " +
                "tar -xz && " +
                "sudo cd screen-4.9.1 && " +
                "sudo ./configure && " +
                "sudo make && " +
                "sudo make install && " +
                "sudo cd .. && " +
                "sudo rm -rf screen-4.9.1 && " +
                "cd - && " +
                "rm -rf /tmp/installer-screen")
    }
