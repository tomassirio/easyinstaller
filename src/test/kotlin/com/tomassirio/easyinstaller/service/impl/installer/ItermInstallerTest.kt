...
class ItermInstallerTest {
    ...
    @InjectMocks
    private lateinit var itermInstaller: ItermInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.iterm")

        ReflectionTestUtils.setField(itermInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${itermInstaller.DEFAULT_URL}"
