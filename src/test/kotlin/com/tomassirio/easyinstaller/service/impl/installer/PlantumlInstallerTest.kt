...
class PlantumlInstallerTest {
    ...
    @InjectMocks
    private lateinit var plantumlInstaller: PlantumlInstaller
    ...
    fun `test successful installation with provided package manager`() {
        ...
        plantumlInstaller.install()

        verify(shellFormatter).printInfo("Installing Plantuml...")
        verify(strategy).install("plantuml")
    }
