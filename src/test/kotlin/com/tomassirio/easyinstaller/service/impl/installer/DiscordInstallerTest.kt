...
class DiscordInstallerTest {
    ...
    @InjectMocks
    private lateinit var discordInstaller: DiscordInstaller
    ...
    fun `test successful installation with provided package manager`() {
        ...
        discordInstaller.install()

        verify(shellFormatter).printInfo("Installing Discord...")
        verify(strategy).install("discord")
    }
