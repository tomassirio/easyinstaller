...
class MavenInstallerTest {
    ...
    @InjectMocks
    private lateinit var mavenInstaller: MavenInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.maven")

        ReflectionTestUtils.setField(mavenInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${mavenInstaller.DEFAULT_URL}"
