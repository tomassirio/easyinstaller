...
class JenkinsInstallerTest {
    ...
    @InjectMocks
    private lateinit var jenkinsInstaller: JenkinsInstaller
    ...
    fun `test successful installation with provided package manager`() {
        ...
        jenkinsInstaller.install()

        verify(shellFormatter).printInfo("Installing Jenkins...")
        verify(strategy).install("jenkins")
    }
