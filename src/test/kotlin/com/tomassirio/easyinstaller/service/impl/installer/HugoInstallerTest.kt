...
class HugoInstallerTest {
    ...
    @InjectMocks
    private lateinit var hugoInstaller: HugoInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.hugo")

        ReflectionTestUtils.setField(hugoInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${hugoInstaller.DEFAULT_URL}"
