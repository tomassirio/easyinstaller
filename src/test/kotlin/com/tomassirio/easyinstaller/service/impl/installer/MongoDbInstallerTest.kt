...
class MongoDbInstallerTest {
    ...
    @InjectMocks
    private lateinit var mongoDbInstaller: MongoDbInstaller
    ...
    fun `test successful installation with provided package manager`() {
        ...
        mongoDbInstaller.install()

        verify(shellFormatter).printInfo("Installing MongoDb...")
        verify(strategy).install("mongodb")
    }
