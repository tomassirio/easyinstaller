...
class DjangoInstallerTest {
    ...
    @InjectMocks
    private lateinit var djangoInstaller: DjangoInstaller
    ...
    fun `test successful installation with provided package manager`() {
        ...
        djangoInstaller.install()

        verify(shellFormatter).printInfo("Installing Django...")
        verify(strategy).install("django")
    }
