...
class TmuxInstallerTest {
    ...
    @InjectMocks
    private lateinit var tmuxInstaller: TmuxInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.tmux")

        ReflectionTestUtils.setField(tmuxInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${tmuxInstaller.DEFAULT_URL}"
