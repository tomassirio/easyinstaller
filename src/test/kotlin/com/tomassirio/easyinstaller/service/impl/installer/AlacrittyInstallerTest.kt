...
class AlacrittyInstallerTest {
    ...
    @InjectMocks
    private lateinit var alacrittyInstaller: AlacrittyInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.alacritty")

        ReflectionTestUtils.setField(alacrittyInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test successful installation with default command`() {
        ...
        alacrittyInstaller.install()

        verify(shellFormatter).printInfo("Installing Alacritty...")
        verify(strategy).invoke(alacrittyInstaller.DEFAULT_URL)
    }
    ...
    fun `test successful installation with provided package manager`() {
        ...
        verify(shellFormatter).printInfo("Installing Alacritty...")
        verify(strategy).install("alacritty")
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${alacrittyInstaller.DEFAULT_URL}"
