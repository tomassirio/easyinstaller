...
class GpgInstallerTest {
    ...
    @InjectMocks
    private lateinit var gpgInstaller: GpgInstaller
    ...
    fun setUp() {
        ...
        val defaultCommand = properties.getProperty("url.default.gpg")

        ReflectionTestUtils.setField(gpgInstaller, defaultCommandField, defaultCommand)
    }
    ...
    fun `test default curl URL is valid`() {
        ...
        val modifiedCommand = "curl --head ${gpgInstaller.DEFAULT_URL}"
