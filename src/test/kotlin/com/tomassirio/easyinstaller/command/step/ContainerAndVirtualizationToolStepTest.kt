...
class ContainerAndVirtualizationToolStepTest {
    ...
    @InjectMocks
    private lateinit var containerAndVirtualizationToolStep: ContainerAndVirtualizationToolStep
    ...
    fun `execute should return selected applications`() {
        ...
        // Execute
        val result = containerAndVirtualizationToolStep.execute()
